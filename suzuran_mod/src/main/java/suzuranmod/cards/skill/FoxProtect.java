...
public class FoxProtect extends SuzuranCard {
    public static final String ID = IdHelper.makePath("FoxProtect");
    
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID); 
    public static final String NAME = CARD_STRINGS.NAME;
    public static final String IMG =ImageHelper.getCardImgPath(CardType.SKILL, "FoxProtect",true);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        p, p,
        new com.megacrit.cardcrawl.powers.IntangiblePlayerPower(p, this.magicNumber),
        this.magicNumber
    ));
    }
